...
namespace SchoolManagementSystem_V1.Controllers
{
    public class ExamsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ExamId,SubjectId,ExamName,ExamDate,ExamDuration,StartTime,EndTime,TotalMarks,PassingMarks,ExamStatus")] Exam exam)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("ExamId,SubjectId,ExamName,ExamDate,ExamDuration,StartTime,EndTime,TotalMarks,PassingMarks,ExamStatus")] Exam exam)
        {
            if (id != exam.ExamId)
            {
                return NotFound();
