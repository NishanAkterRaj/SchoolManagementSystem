...
namespace SchoolManagementSystem_V1.Controllers
{
    public class SessionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SessionId,SessionName")] Session session)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("SessionId,SessionName")] Session session)
        {
