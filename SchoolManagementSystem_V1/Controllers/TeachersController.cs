...
namespace SchoolManagementSystem_V1.Controllers
{
    public class TeachersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TeacherId,FirstName,LastName,Photo,Gender,MaritalStatus,DateOfBirth,Nid,Religion,Phone,Email,Nationality,Qualification,Salary")] Teacher teacher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("TeacherId,FirstName,LastName,Photo,Gender,MaritalStatus,DateOfBirth,Nid,Religion,Phone,Email,Nationality,Qualification,Salary")] Teacher teacher)
        {
